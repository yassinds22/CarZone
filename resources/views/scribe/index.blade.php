    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="brand-management">
                    <a href="#brand-management">Brand Management</a>
                                ...
                                <a href="#brand-management-POSTapi-brands">Store a new brand</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="brand-management-GETapi-brands--id-">
                                <a href="#brand-management-GETapi-brands--id-">Show brand details</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="brand-management-PUTapi-brands--id-">
                                <a href="#brand-management-PUTapi-brands--id-">Update brand</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="brand-management-DELETEapi-brands--id-">
                                <a href="#brand-management-DELETEapi-brands--id-">Delete brand</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-PUTapi-auth--id-">PUT api/auth/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-auth--id-">
                                <a href="#endpoints-DELETEapi-auth--id-">DELETE api/auth/{id}</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="products-management">
                    <a href="#products-management">Products Management</a>
                                ...
                                <a href="#products-management-GETapi-products--id-">Get Single Product</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="provinces-management">
                    <a href="#provinces-management">Provinces Management</a>
                                ...
                                <a href="#provinces-management-GETapi-provinces">Get a list of all provinces.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="provinces-management-POSTapi-provinces">
                                <a href="#provinces-management-POSTapi-provinces">Create a new province.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="provinces-management-GETapi-provinces--id-">
                                <a href="#provinces-management-GETapi-provinces--id-">Get a specific province by ID.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="provinces-management-PUTapi-provinces--id-">
                                <a href="#provinces-management-PUTapi-provinces--id-">Update an existing province.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="provinces-management-DELETEapi-provinces--id-">
                                <a href="#provinces-management-DELETEapi-provinces--id-">Delete a province by ID.</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-auth"
               value="Yassin Ali"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="google_id"                data-endpoint="POSTapi-auth"
               value="1234567890"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="POSTapi-auth"
               value="+967770000000"
               data-component="body">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/allData" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"Yassin Ali\",
...
<span id="execution-results-POSTapi-allData" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-allData"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-allData"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-allData" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-allData">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-allData" data-method="POST"
      data-path="api/allData"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-allData', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-allData"
                    onclick="tryItOut('POSTapi-allData');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-allData"
                    onclick="cancelTryOut('POSTapi-allData');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-allData"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-allData"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-allData"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-allData"
               value="Yassin Ali"
               data-component="body">
    <br>
<p>The user's full name. Example: <code>Yassin Ali</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="google_id"                data-endpoint="POSTapi-allData"
               value="1234567890"
               data-component="body">
    <br>
<p>optional The user's Google ID. Example: <code>1234567890</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="POSTapi-allData"
               value="+967770000000"
               data-component="body">
    <br>
<p>optional The user's phone number. Example: <code>+967770000000</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="brand-management-POSTapi-brands">Store a new brand</h2>

<p>
</p>

<p>Create a new brand with optional image upload.</p>
...
<div class="bash-example">
    ...
    --form "name=Samsung"\
    --form "is_active=1"\
    --form "image=@C:\Users\yassin\AppData\Local\Temp\php8BED.tmp" </code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The brand name. Example: <code>Samsung</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>is_active</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
<i>optional</i> &nbsp;
                <label data-endpoint="POSTapi-brands" style="display: none">
            <input type="radio" name="is_active"
                   value="true"
                   data-endpoint="POSTapi-brands"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="POSTapi-brands" style="display: none">
    ...
    <br>
<p>Whether the brand is active (optional). Example: <code>true</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="image"                data-endpoint="POSTapi-brands"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\yassin\AppData\Local\Temp\php8BED.tmp</code></p>
        </div>
        </form>

                    <h2 id="brand-management-GETapi-brands--id-">Show brand details</h2>

<p>
</p>

<p>Display a specific brand by ID.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/brands/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/brands/17"
);
...
<p>The ID of the brand. Example: <code>17</code></p>
                    ...
                    <h2 id="brand-management-PUTapi-brands--id-">Update brand</h2>

<p>
</p>

<p>Update an existing brand with optional image replacement.</p>
...
<div class="bash-example">
    ...
    --form "name=Samsung"\
    --form "is_active=1"\
    --form "image=@C:\Users\yassin\AppData\Local\Temp\php8C1C.tmp" </code></pre></div>
...
<small>boolean</small>&nbsp;
<i>optional</i> &nbsp;
                <label data-endpoint="PUTapi-brands--id-" style="display: none">
            <input type="radio" name="is_active"
                   value="true"
                   data-endpoint="PUTapi-brands--id-"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-brands--id-" style="display: none">
...
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="image"                data-endpoint="PUTapi-brands--id-"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\yassin\AppData\Local\Temp\php8C1C.tmp</code></p>
        </div>
        </form>

                    <h2 id="brand-management-DELETEapi-brands--id-">Delete brand</h2>

<p>
</p>

<p>Remove a brand by ID.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-auth">Display all users (for testing only)</h2>
...
<span id="example-requests-PUTapi-auth--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-auth--id-">
</span>
<span id="execution-results-PUTapi-auth--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-auth--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-auth--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-auth--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-auth--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-auth--id-" data-method="PUT"
      data-path="api/auth/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-auth--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-auth--id-"
                    onclick="tryItOut('PUTapi-auth--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-auth--id-"
                    onclick="cancelTryOut('PUTapi-auth--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-auth--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-auth--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-auth--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-auth--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the auth. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-auth--id-">DELETE api/auth/{id}</h2>
...
<span id="example-requests-DELETEapi-auth--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-auth--id-">
</span>
<span id="execution-results-DELETEapi-auth--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-auth--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-auth--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-auth--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-auth--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-auth--id-" data-method="DELETE"
      data-path="api/auth/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-auth--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-auth--id-"
                    onclick="tryItOut('DELETEapi-auth--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-auth--id-"
                    onclick="cancelTryOut('DELETEapi-auth--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-auth--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-auth--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-auth--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-auth--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the auth. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-allData">Display all users (for testing only)</h2>
...
<span id="example-requests-GETapi-allData">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-allData">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-allData" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-allData"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-allData"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-allData" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-allData">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-allData" data-method="GET"
      data-path="api/allData"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-allData', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-allData"
                    onclick="tryItOut('GETapi-allData');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-allData"
                    onclick="cancelTryOut('GETapi-allData');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-allData"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-allData"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-allData"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<span id="example-requests-PUTapi-allData--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-allData--id-">
</span>
<span id="execution-results-PUTapi-allData--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-allData--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-allData--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-allData--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-allData--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-allData--id-" data-method="PUT"
      data-path="api/allData/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-allData--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-allData--id-"
                    onclick="tryItOut('PUTapi-allData--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-allData--id-"
                    onclick="cancelTryOut('PUTapi-allData--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-allData--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-allData--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-allData--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-allData--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the allDatum. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-allData--id-">DELETE api/allData/{id}</h2>
...
<span id="example-requests-DELETEapi-allData--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-allData--id-">
</span>
<span id="execution-results-DELETEapi-allData--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-allData--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-allData--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-allData--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-allData--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-allData--id-" data-method="DELETE"
      data-path="api/allData/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-allData--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-allData--id-"
                    onclick="tryItOut('DELETEapi-allData--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-allData--id-"
                    onclick="cancelTryOut('DELETEapi-allData--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-allData--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-allData--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-allData--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="DELETEapi-allData--id-"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the allDatum. Example: <code>consequatur</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="products-management-GETapi-products--id-">Get Single Product</h2>
...
<p>Delete a product by its ID.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="provinces-management-POSTapi-provinces">Create a new province.</h2>
...
<span id="example-requests-POSTapi-provinces">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-provinces">
            <blockquote>
            <p>Example response (201):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-provinces" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-provinces"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-provinces"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-provinces" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-provinces">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-provinces" data-method="POST"
      data-path="api/provinces"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-provinces', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-provinces"
                    onclick="tryItOut('POSTapi-provinces');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-provinces"
                    onclick="cancelTryOut('POSTapi-provinces');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-provinces"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-provinces"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-provinces"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-provinces"
               value="Sana'a"
               data-component="body">
    <br>
<p>The name of the province. Example: <code>Sana'a</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="parent_id"                data-endpoint="POSTapi-provinces"
               value="1"
               data-component="body">
    <br>
<p>nullable The ID of the parent province (if any). Example: <code>1</code></p>
        </div>
        </form>

                    <h2 id="provinces-management-GETapi-provinces--id-">Get a specific province by ID.</h2>
...
<p>The ID of the province. Example: <code>1</code></p>
                    ...
                    <h2 id="provinces-management-PUTapi-provinces--id-">Update an existing province.</h2>
...
<span id="example-requests-PUTapi-provinces--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost:8000/api/provinces/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"Sana\'a\",
...
<span id="example-responses-PUTapi-provinces--id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-PUTapi-provinces--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-provinces--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-provinces--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-provinces--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-provinces--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-provinces--id-" data-method="PUT"
      data-path="api/provinces/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-provinces--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-provinces--id-"
                    onclick="tryItOut('PUTapi-provinces--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-provinces--id-"
                    onclick="cancelTryOut('PUTapi-provinces--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-provinces--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-provinces--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-provinces--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-provinces--id-"
               value="17"
               data-component="url">
    <br>
<p>The ID of the province to update. Example: <code>17</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-provinces--id-"
               value="Sana'a"
               data-component="body">
    <br>
<p>The name of the province. Example: <code>Sana'a</code></p>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="parent_id"                data-endpoint="PUTapi-provinces--id-"
               value="1"
               data-component="body">
    <br>
<p>nullable The ID of the parent province (if any). Example: <code>1</code></p>
                    ...
                    <h2 id="provinces-management-DELETEapi-provinces--id-">Delete a province by ID.</h2>
...
<span id="example-requests-DELETEapi-provinces--id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-provinces--id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-DELETEapi-provinces--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-provinces--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-provinces--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-provinces--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-provinces--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-provinces--id-" data-method="DELETE"
      data-path="api/provinces/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-provinces--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-provinces--id-"
                    onclick="tryItOut('DELETEapi-provinces--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-provinces--id-"
                    onclick="cancelTryOut('DELETEapi-provinces--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-provinces--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-provinces--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-provinces--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-provinces--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the province to delete. Example: <code>1</code></p>
            </div>
                    </form>
